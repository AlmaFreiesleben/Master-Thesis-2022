...
def compute_mean():
    for i in range(112):
        ...
        y.append(mean_cov)
    x.append(t7[len(t7)-1])
    y.append(c7[len(c7)-1])
...
plt.scatter(t6, c6, s=1, c='hotpink')
plt.scatter(t7, c7, s=1, c='hotpink')
plt.scatter(t8, c8, s=1, c='hotpink')
plt.scatter(t9, c9, s=1, c='hotpink')
plt.scatter(t10, c10, s=1, c='hotpink')
...
plt.grid()
plt.savefig("graph_zigzag_10_runs.png")
plt.show()